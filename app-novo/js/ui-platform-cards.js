...
// SPA: diferente do Sistema 1 (cada carregamento de página recriava o
// módulo do zero), aqui o módulo é importado UMA ÚNICA VEZ pra vida
// inteira da aplicação — sair da rota Calendário e voltar NÃO reseta
// essas variáveis sozinho. Sem isso, o campo de busca reapareceria
// vazio (o HTML é reconstruído do zero no mount()) mas o filtro/
// ordenação da visita anterior continuaria aplicado por trás,
// dessincronizando o que aparece no input do que é mostrado na grade.
// Chamada por view-calendario.js, no início do mount(), antes de
