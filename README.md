...
<body class="p-4 sm:p-5">
  ...
  <div class="container mx-auto relative z-10">
    <div class="logo-container flex items-center justify-center flex-wrap gap-4">
      <img src="Logo.jpeg" alt="Logo PAFCS Data Solutions" class="logo">
      <div class="titulo-principal flex items-center gap-2">
        <span class="gradient-title">IA para Todos!</span>
        <svg class="neural-icon pulse-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="32" height="32">
