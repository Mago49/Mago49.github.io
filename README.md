...
<head>
    ...
    <style>
        ...
        /* Estilo do SVG para cobrir todo o fundo */
        .background-svg {
            position: absolute;
            top: 0;
            left: 0;
        ...
        /* Estilos do botão de CTA, mais elegante */
        .cta-button {
        ...
        .cta-button:hover {
            background-image: linear-gradient(45deg, #357ae8, #2e9f4e);
...
<body class="p-4 sm:p-5">
    <svg class="background-svg" viewBox="0 0 1440 800" xmlns="http://www.w3.org/2000/svg">
        <rect x="0" y="0" width="1440" height="800" fill="#000000"/>
        <path d="M 0, 800 L 0, 600 C 180, 560 360, 620 540, 600 C 720, 580 900, 520 1080, 500 C 1260, 480 1440, 520 1440, 500 L 1440, 800 Z" fill="#EA4335" />
        <path d="M 0, 800 L 0, 450 C 180, 480 360, 500 540, 450 C 720, 400 900, 300 1080, 350 C 1260, 400 1440, 450 1440, 450 L 1440, 800 Z" fill="#FBBC05" />
        <path d="M 0, 800 L 0, 300 C 180, 340 360, 400 540, 350 C 720, 300 900, 200 1080, 250 C 1260, 300 1440, 340 1440, 300 L 1440, 800 Z" fill="#34A853" />
        <path d="M 0, 800 L 0, 150 C 180, 200 360, 300 540, 250 C 720, 200 900, 100 1080, 150 C 1260, 200 1440, 250 1440, 200 L 1440, 800 Z" fill="#4285F4" />
    </svg>
